...
class _AnimatedTextFormFieldState extends State<AnimatedTextFormField> {
  ...
  InputDecoration _getInputDecoration(String hintText) {
    return InputDecoration(
      ...
      hintText: hintText,
      contentPadding: EdgeInsetsDirectional.only(top: 15.0),
  ...
  InputDecoration _getInputDecorationTwo(String hintText) {
    return InputDecoration(
      fillColor: Color.fromARGB(15, 10, 10, 10),
      enabledBorder: InputBorder.none,
      focusedBorder: InputBorder.none,
      hintText: hintText,
      contentPadding: EdgeInsetsDirectional.only(top: 15.0),
  ...
  Widget build(BuildContext context) {
    Widget textField = widget.showCard == true ? Card(
      color: Color.fromARGB(255, 255, 255, 255),
      child: Container(
        padding: EdgeInsets.symmetric(vertical: 4,horizontal: 7),
        child: TextFormField(
         cursorColor: Color.fromARGB(255, 0, 51, 114),
          controller: widget.controller,
          focusNode: widget.focusNode,
          decoration: _getInputDecoration(widget.labelText!),
      ...
      child: TextFormField(
        ...
        controller: widget.controller,
        focusNode: widget.focusNode,
        decoration: _getInputDecorationTwo(widget.labelText!),
        keyboardType: widget.keyboardType,
        textInputAction: widget.textInputAction,
        obscureText: widget.obscureText,
        // onFieldSubmitted: widget.onFieldSubmitted,
...
class _AnimatedPasswordTextFormFieldState
  ...
  Widget build(BuildContext context) {
    return AnimatedTextFormField(
      ...
      prefixIcon: const Icon(Icons.vpn_key, size: 20,color: Color.fromARGB(255, 0, 51, 114),),
