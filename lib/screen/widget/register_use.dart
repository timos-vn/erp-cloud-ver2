...
class RegisterUseComponent extends StatefulWidget {
  final String? title;
  final String? content;

  const RegisterUseComponent({Key? key, this.title, this.content,}) : super(key: key);
  @override
  _RegisterUseComponentState createState() => _RegisterUseComponentState();
}

class _RegisterUseComponentState extends State<RegisterUseComponent> {
  @override
